// I ensure that only visible word were counted
// and hidden. I avoided hiding already hidden words.
// I also check to that is the remaining word is less than
// the number of words to be hidden, then the remaining words
// were hidden. 
...
class Program
{
    static void Main(string[] args)
    {
        ...
        string scriptureText = @"Trust in the Lord with all thine heart; 
